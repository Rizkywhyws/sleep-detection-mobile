...
class ProfileMenuList extends StatelessWidget {
  ...
  static const List<_MenuItemData> _items = [
    _MenuItemData(
      ...
      subtitle: 'Kata sandi, notifikasi, dan lainnya',
  ...
  VoidCallback _resolveOnTap(BuildContext context, int index) {
    switch (index) {
      case 0: // Pengaturan Akun
        return () => Navigator.of(
          context,
        ).push(_buildRoute(const AccountSettingsScreen()));
      case 1: // Tujuan Tidur
        return () =>
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: isDark
                          ? Border.all(
                              color: data.iconColor.withOpacity(0.28),
                              width: 0.9,
                            )
                          : null,
                      boxShadow: isDark
                          ? [
                              BoxShadow(
                                color: data.iconColor.withOpacity(0.20),
                                blurRadius: 8,
                              ),
                            ]
                          : null,
